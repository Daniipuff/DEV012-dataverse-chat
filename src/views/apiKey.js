...
export const componenteApiKey = () => {
  ...
  const tituloApiKey = document.createElement('h3');
  ...
  const entradaContraseña = document.createElement('input');
  ...
  const valorContraseña = contenedorApiKey.querySelector('.inputKey');
